                ...
                <div className="container">
                    <div className="box flex flex-row">
                        ...
                        <div className='relative bg-white h-[700px] w-[650px] flex flex-col justify-center items-center border shadow-2xl rounded-e-lg'>
                            <h1 className='text-7xl font-medium text-blue-400 pt-8' >Welcome</h1>
                            ...
                            <div className='relative mt-1' >
                                ...
                                <div className='absolute text-sm right-0 mt-1' >
                                    <span>Already have an account? </span><span className='text-blue-500 cursor-pointer' ><Link to="/login">Login</Link></span>
                                </div>
                            </div>
                            <div className='mt-24 '>
                                <button className='pl-16 pr-16 pt-3 pb-3 bg-blue-400 text-white font-medium text-lg rounded-lg hover:bg-blue-300'><Link to="/home">Create Account</Link>
                                </button>
                            </div>
                            <div className='flex '>
